...
<template>
  ...
  >
    ...
    >
      {{ useDateFormat(frontmatter.date, 'YYYY-MM-DD') }} <span v-if="frontmatter.duration">· {{ frontmatter.duration }}</span>
    </p>
  ...
  <div
    v-if="route.path !== '/'"
    class="slide-enter m-auto mb-8 mt-8 animate-delay-500 prose print:hidden"
  >
